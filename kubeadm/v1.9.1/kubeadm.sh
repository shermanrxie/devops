...
kube_repository()
{
    ...
    #KUBE_REPO_PREFIX环境变量已经失效，需要通过MasterConfiguration对象进行设置  #registry.cn-hangzhou.aliyuncs.com/szss_k8s
    export KUBE_REPO_PREFIX=docker.io/mirrorgooglecontainers
}
